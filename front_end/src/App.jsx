...
function App() {
  let isLoggedIn = localStorage.getItem(Constants.LOGGED_IN) === "true";
            ...
            <Dropdown placement="bottom-right">
              ...
              <Dropdown.Menu aria-label="User menu actions" color="secondary">
                <Dropdown.Item
                  ...
                  withDivider
                  textValue
                  css={{ height: "$17", width: "$60" }}
                >
                  <Button
                    flat
                    light
                    css={{ height: "$18", justifyContent: "flex-start" }}
                  >
      ...
      <Router>
        <Routes>
          <Route
            exact
            path="/"
            element={isLoggedIn ? <Calendar /> : <SignIn />}
          />
          <Route
            path="/calendar"
          ...
          <Route
            path="/familygroups"
            element={isLoggedIn ? <FamilyGroups /> : <Navigate to="/" />}
          />
          <Route
            path="/signout"
            element={isLoggedIn ? <SignOut /> : <Navigate to="/" />}
          />
          <Route
            path="/profile"
          ...
          />
          <Route
            path="/familymemberprofile"
            element={isLoggedIn ? <FamilyMemberProfile /> : <Navigate to="/" />}
          />
