...
const DeleteRecurrence = (props) => {
  ...
  const deleteRecurrence = (props) => {
    axios.post("http://localhost:8080/api/events/deleteRecurrence", 
    {
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Footer>
          <Button flat auto color="error" onPress={() => deleteEvent(props.eventProps)}>
            Delete this event
          </Button>
          <Button flat auto color="error" onPress={() => deleteRecurrence(props.eventProps)}>
